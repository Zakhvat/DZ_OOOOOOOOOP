...
Студенты: [Хватов Захар, Черноскутов Роман, Гаврильчук Денис]
Группа: [Крутые парни]
Вариант: 1 (MAPE)
"""
...
#давай в 223 строку вместе что-нибудь напишем
#Сломали?
#да, мы всё сломали...


#Пхахаха, у меня сломалось всё
#Смотри, видишь мои комменты? Я вроде перезагрузил, починился